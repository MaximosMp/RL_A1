...
from Q_learning import q_learning  # Q_learning_solution
from SARSA import sarsa  # SARSA_solution
from MonteCarlo import monte_carlo  # MonteCarlo_solution
from Nstep import n_step_Q  # Nstep_solution
...
def experiment():
    ...
    # set the optimal average reward per timestep you found in the DP assignment here
